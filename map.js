...
[{ label: 'B1', text: 'A tölgyfa akkorát reccsent mérgében, hogy a mókuskák ijedtükben majdnem lepotyogtak róla. Csak a hízelgő szél tudott befurakodni a lombjai közé. Annak a duruzsolását hallgatta reggeltől estig. Lassan mindenki elkerülte. Már az őz sem mert a kérgéhez törleszkedni. Igazán mondom, egyszer a saját szememmel láttam mellette kibujni egy gombát a földből, de amint észrevette, hogy hol van, gyorsan kalapot emelt, és elgyalogolt máshová. Képzeljétek!… már az árnyéka sem kellett senkinek!' },
  { label: 'B2', text: 'Egy darabig így is megvolt a tölgyfa. Hanem idővel az évgyűrűk vastagítani kezdték a derekát, és – tetszett vagy nem tetszett! – belebújt a kukac. Hosszú éjszakákon át kegyetlenül rágta. A tölgyfa hasogató fájdalmakra ébredt. Tavasz volt akkoriban. Minden fa boldogan érezte magában az új nedvek keringését, csak a tölgyfa állt rosszkedvűen, magányosan, szárazon. A féreg egyre jobban gyötörte.' },
  { label: 'B3', text: '- Ó, jaj nekem – sóhajtotta -, elpusztulok!' },
  { label: 'B4', text: 'Keserves nyögését meghallotta a közelben tanyázó mókusasszonyka. Tüstént abbahagyta fiacskái mosdatását.' },
  { label: 'B5', text: '- Miért nem szóltál, hogy beteg vagy? – kérdezte sajnálkozva. – Mindjárt idehívom Harkály doktort!' }],
...
[{ label: 'D1', text: 'Körös-körül őzek, mókusok leskelődtek, madarak figyelték, hogy mi lesz. Mindenki örült, amikor a doktor bekapta a kukacot. A tölgyfa pedig csodálkozva kérdezte:' },
  { label: 'D2', text: '- Miért segítettél rajtam? Hiszen énrám mindenki haragszik!' },
  { label: 'D3', text: 'Erre a körülállók kacagni kezdte, és a harangvirágok összekoccantották fejecskéjüket.' },
  { label: 'D4', text: '- Ó, te tölgyfa!… Senki sem haragszik rád, hanem te haragudtál az egész világra!' },
  { label: 'D5', text: 'Harkály doktor hozzátette:' }],
